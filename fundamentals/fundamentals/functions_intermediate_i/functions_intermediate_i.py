# Note: Avoid using class keywords like int, str, list, 
# and dict as variable/parameter names.
...
def iterateDictionary(list_of_students):
...
def printInfo(some_dict):
    for key_value_pair in some_dict:
        print(f"{len(some_dict[f'{key_value_pair}'])} {key_value_pair.upper()}")
        sub_list = (some_dict[key_value_pair])
